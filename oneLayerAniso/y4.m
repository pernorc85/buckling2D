function y4=F(y1,y2,y3,R,r,n,gamma)
...
PI=3.141592654;
%gamma=PI/4;%angular orientation of collagen fibers in the cross section
k1=1;%parameters for anisotropic material properties
k2=0.2;
alpha=r/R;
