%boundary conditions
function bc1_aniso=F(y1,y2,y3,y4,R,r,n,mu,k1,k2,gamma,g1,g2)
...
B1212_pp = 4*W4_pp*alpha^(-2)*sin(gamma)^2 + 4*W4_p*EE*sin(gamma)^2 + 4*W4*EEEE*sin(gamma)^2+...
...
bc1_aniso = C3 * y4 + C2 * y3 + C1 * y2 + C0 * y1;
