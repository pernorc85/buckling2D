%boundary condition--normal stress

function bc1=F(y1,y2,y3,y4,R,r,mu,n,g1,g2)
%bc1 = g1*g2^4*R^4*r^3*y4+(2*g2^3*R^2*r^4+2*g1*g2^4*R^4*r^2)*y3+(2*g2^3*R^2*r^3-2*g1*g2^4*n^2*R^4*r-g1*g2^4*R^4*r-g1*n^2*r^5)*y2+...
%      (n^2-1)*(2*g2^3*R^2*r^2-g1*g2^4*R^4)*y1;
...
%have to adjust Pnormal after adjusting C0, C1, C2, C3
...
bc1 = (C3 * y4 + C2 * y3 + C1 * y2 + C0 * y1);%*R^2*r^2*g1*g2^2;
